...
// Instantiation and passing `true` enables exceptions
    ...
    try {
        ...
        //Recipients
        //  Thông tin người gửi
        $mail->setFrom('hoanghung.developer2@gmail.com', 'Salon Hair VVH');
    ...
    if ($firstname != "" && $lastname != "" && $password != "" && $email != "" && $confirm != "") {
        ...
        if ($conn->query($sql) === true) {
            $content = 'Chúc mừng bạn đã đăng ký tài khoản thành công<br>
                ...
                'Click vào đây để kích hoạt tài khoản <a href="http://' . $_SERVER['HTTP_HOST'] . '/Salon_hair/resource/view/pages/authentication/active-account.php?email=' . $email . '&time='.$time.'">Kích hoạt tài khoản</a>';
