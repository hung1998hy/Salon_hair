    ...
    if (empty($_POST["emailForgot"])) {
        ...
        if (mysqli_num_rows($sql) === 0) {
            ...
            $content = 'Đặt lại mật khẩu' . '<br>' .
                'Click vào đây để đặt lại mật khẩu <a href="http://' . $_SERVER['HTTP_HOST'] . '/Salon_hair/resource/view/pages/authentication/resetPassword.php?email=' . $email . '">Đặt lại mật khẩu</a>';
